...
export const exportTxt = (content: string, fileName: string) => {
...
export const exportPdf = async (content: string, fileName: string) => {
...
export const exportDocx = (content: string, fileName: string) => {
